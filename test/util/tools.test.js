...
describe('test/util/tools.js',function () {
  ...
  describe('minutesAfter', function() {
		it('should return right time',function () {
			var now = new Date();
			var after = tools.minutesAfter(now, 10);
      (after.getMinutes() - now.getMinutes()).should.be.equal(10);
		});
	});
});
